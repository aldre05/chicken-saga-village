...
## Why
Chicken Saga has no explorable/village-style game. This proposal
starts a new, separate project inspired by the addictive gameplay loop
of top-down village/hero games (e.g. Pixiland's genre — explorable
world, buildings, NPCs) using original branding and CC0 assets, not
copied IP. It replaces the earlier idle-tycoon direction, which is
paused.
